...
const createTables = async () => {
  ...
  const insertLocations = `
    ...
    VALUES
      (1, 'Echo Lounge', 'An intimate venue known for indie and alternative acts with a vibrant atmosphere and great acoustics.', 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&w=600'),
      (2, 'House of Blues', 'A legendary music hall hosting everything from rock to R&B with a soulful Southern vibe.', 'https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=600'),
      (3, 'The Pavilion', 'An outdoor amphitheater perfect for summer concerts under the stars.', 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?auto=format&fit=crop&w=600'),
      (4, 'American Airlines Arena', 'A massive arena hosting the biggest names in music, sports, and entertainment.', 'https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?auto=format&fit=crop&w=600');
  `
